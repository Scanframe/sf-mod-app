...
TEST_CASE("sf::ResultData", "[result]")
{
	...
	SECTION("Events:Creation")
	{
		...
		sf::ResultData r_server1(std::string("0x9001,Test INT8,A,Compiler Test result type INT8.,INT8,1024,256"));
		r_server1.setHandler(&handler_server1);

		// Create other owner instance.
		sf::ResultData r_server2(std::string("0x9003,Test INT32,SA,Compiler Test result type INT32.,INT32,25,1024"));
