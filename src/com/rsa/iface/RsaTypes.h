...
struct _RSA_CLASS RsaTypes
{
	 ...
	 */
		struct _RSA_CLASS ResultInfo
		{
				...
				unsigned Index{0};
				/**
				 * @brief Holds the channel number of this parameter.
				 * When channel is UINT_MAX the param is not a gate related param.
				 */
				unsigned Channel{0};
				/**
				...
				/**
				 * @brief Level offset of the generated data.
				 */
				int Offset{0};
		};
	 ...
	 */
		 ...
		 * List of ids which must always be present at all times for each ultrasonic acquisition implementation.
		 */
