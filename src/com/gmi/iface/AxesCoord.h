...
class _GMI_CLASS AxesCoord
{
	public:
		...
		/**
			 ...
			 * @param axis_loc The target axis #sf::gmi::EAxisLocation.
			 * @param value The axis value in axis units.
			 */
		void set(int axis_loc, double value);
		...
		/**
			 ...
			 * @return Axis value.
			 */
		double getValue(int axis_loc) const;
		...
		/**
			 * @brief Get a string with all axes information.
			 */
		...
		/**
			 ...
			 * @param ac Axes coord being compared.
			 * @param tolerance Axes values containing accuracy of the comparison.
			 * @param rad_unlimited Set of radial unlimited axis.
			 * @return
			 */
